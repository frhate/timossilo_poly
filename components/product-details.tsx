            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="space-y-4">
                <Card className="overflow-hidden border-2 shadow-lg">
                  <div className="relative w-full aspect-square bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-8">
                    <Image
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-4">
                        <div className="flex items-center border-2 rounded-lg overflow-hidden">
                          ...
                          <div className="min-w-[80px] h-12 flex items-center justify-center text-xl font-bold border-x-2">
                            {quantity}
                          </div>
