...
import {ShoppingCart, Menu, X, LogOut, User, Settings, LayoutGrid, GitCompare, Smartphone} from "lucide-react"
...
export default function Navigation() {
    ...
    return (
        <nav className="sticky top-0 z-50 bg-background border-b border-border/50 shadow-sm">
                ...
                <div className="flex items-center justify-between h-20">
                    ...
                    <div className="flex items-center gap-2">
                        <Link href="/" className="flex items-center gap-3 group flex-shrink-0">
                            <div
                                className="w-10 h-10 rounded-lg flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary to-primary/80 shadow-md">
                                <Image
                                    src="/logo.jpg"
                                    alt="Timosilo logo"
                                    width={40}
                            ...
                            <span
                                className="font-bold text-xl tracking-tight text-foreground group-hover:text-primary transition-colors duration-300 hidden sm:inline">
            ...
            {mobileMenuOpen && (
                <div
                    className="md:hidden border-t border-border/50 bg-card/50 backdrop-blur-sm animate-in fade-in slide-in-from-top-2">
